...
TENSOR_NAMES = loading_utils.ModelLoader.TensorNames(
    ff_up_proj="model.layers.{}.ffn.proj_1",
    ff_down_proj="model.layers.{}.ffn.proj_2",
    attn_fused_qkv_proj="model.layers.{}.attn.qkv_proj",
    attn_output_proj="model.layers.{}.self_attn.out_proj",
    pre_attn_norm="model.layers.{}.ffn_norm",
    pre_ff_norm="model.layers.{}.attn_norm",
...
def get_model_config(kv_cache_max_len: int = 1024) -> cfg.ModelConfig:
  ...
  # TODO: activation is swish for OpenELM which isn't supported by this library yet
...
def define_and_run() -> None:
  ...
  checkpoint_path = os.path.join(Path.home(), "Downloads/llm_data/openelm-270")
